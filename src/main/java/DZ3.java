    ...
    public static void getSrting() {
        ...
        while (flag1) {
            ...
            if (group.charAt(0) != A && group.charAt(0) != B
                    && group.charAt(0) != C && group.charAt(0) != D
                    && group.charAt(0) != E && group.charAt(0) != F) {
                System.out.printf("%nA. СТРОКА ЗАГЛАВНЫМИ БУКВАМИ%nB. строка в нижнем регистре%nC. С Заглавной Буквы (Первый Символ Каждого Слова В Строке )%n");
                System.out.printf("D. пЕРВЫЙ сИМВОЛ в нИЖНЕМ рЕГИСТРЕ%nE. Как в предложении(с заглавной буквы)%nF. выход из программы%n");
            ...
            switch (choice) {
                case A:
                    System.out.printf("%nVash vubor СТРОКА ЗАГЛАВНЫМИ БУКВАМИ:%n%s", str.toUpperCase());
                    flag1 = false;
                    break;
                case B:
                    System.out.printf("%nVash vubor строка в нижнем регистре:%n%s",str.toLowerCase());
                    flag1 = false;
                    break;
                case C:
                ...
                case E:
                    ...
                    System.out.printf("%nVash vubor Как в предложении(с заглавной буквы):%n%s", sb);
                    flag1 = false;
                    break;
                case F:
                    flag1 = false;
